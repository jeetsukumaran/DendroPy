...
trees.read_from_path('pythonidae_cytb.mb.run2.t', 'nexus', tree_offset=200)
trees.read_from_path('pythonidae_cytb.mb.run3.t', 'nexus', tree_offset=200)
trees.read_from_path('pythonidae_cytb.mb.run4.t', 'nexus', tree_offset=200)
