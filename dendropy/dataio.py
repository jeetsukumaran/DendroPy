...
FORMATS = [NEXUS, NEXML, NEWICK, FASTA, PHYLIP, DNAFASTA, RNAFASTA, PROTEINFASTA]

READERS = {
    NEXUS: nexus.NexusReader,
    NEWICK: nexus.NewickReader,
    NEXML: nexml.NexmlReader,
    DNAFASTA: fasta.DNAFastaReader,
    RNAFASTA: fasta.RNAFastaReader,
    PROTEINFASTA: fasta.ProteinFastaReader,
}
