...
class NucleotideCharacterEvolutionModel(discrete.DiscreteCharacterEvolutionModel):
    ...
    def __init__(self, base_freqs=None, state_alphabet=None):
        ...
        DiscreteCharacterEvolutionModel.__init__(self, state_alphabet)
...
class Hky85CharacterEvolutionModel(NucleotideCharacterEvolutionModel):
    """
    ...
    def __init__(self, kappa=1.0, base_freqs=None):
        ...
        NucleotideCharacterEvolutionModel.__init__(self, base_freqs=base_freqs)
...
class Jc69CharacterEvolutionModel(Hky85CharacterEvolutionModel):
    """
    Jukes-Cantor 1969 model. Specializes HKY85 such that
    kappa = 1.0, and base frequencies = [0.25, 0.25, 0.25, 0.25].
    """
    def __init__(self):
        "__init__: uses Hky85CharacterEvolutionModel.__init__"
        Hky85CharacterEvolutionModel.__init__(self,
                                     kappa=1.0,
...
def hky_char_matrix(seq_len,
    ...
    """
    seq_model = Hky85CharacterEvolutionModel(kappa=kappa, base_freqs=base_freqs)
    return discrete.simulate_char_matrix(seq_len=seq_len,
