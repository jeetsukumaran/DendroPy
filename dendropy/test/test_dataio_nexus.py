...
class NexusTreeListReaderTest(datatest.DataObjectVerificationTestCase):
    ...
    def testReferenceTreeFileDistinctTaxa(self):
        ...
        t_tree_list = dendropy.TreeList.from_file(pathmap.tree_source_stream("reference.trees.nexus"), "nexus")
    ...
    def testReferenceTreeFileSameTaxa(self):
        ref_tree_list = datagen.reference_tree_list()
        t_tree_list = dendropy.TreeList.from_file(pathmap.tree_source_stream("reference.trees.nexus"), "nexus", taxon_set=ref_tree_list.taxon_set)
        self.assertDistinctButEqualTreeList(
                ref_tree_list,
                t_tree_list,
                distinct_taxa=False,
...
class NexusTreeListWriterTest(datatest.DataObjectVerificationTestCase):
    ...
    def testWriteTreeListDistinctTaxa(self):
        ...
        t_tree_list = dendropy.TreeList.from_path(output_path, "nexus")
        self.assertDistinctButEqualTreeList(
                ref_tree_list,
                t_tree_list,
                distinct_taxa=True,
