...
class BounceConstrainTest(unittest.TestCase):
    ...
    def runTest(self):
        output = [continuous.bounce_constrain(0.5, .5 - 0.05*i, 0.0, 1.0) for i in range(100)]
...
class KTBRatesTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        rng = RepeatedRandom()
        y = [continuous._calc_KTB_rate(0.01+.5*i, 1, j, rng) for i in xrange(10) for j in xrange(10)]
        assert_vec_approx_equal(y, expected, tester=self)

        rng = RepeatedRandom()
        y = [continuous._calc_KTB_rate(0.01+.5*i, j, 1, rng) for i in xrange(10) for j in xrange(10)]
        assert_vec_approx_equal(y, expected, tester=self)
...
class TKPRatesTest(unittest.TestCase):
    ...
    def runTest(self):
        ...
        rng = RepeatedRandom()
        y = [continuous._calc_TKP_rate(0.01+.5*i, 1, j, rng) for i in xrange(10) for j in xrange(10)]
        assert_vec_approx_equal(y, expected, tester=self)

        rng = RepeatedRandom()
        y = [continuous._calc_TKP_rate(0.01+.5*i, j, 1, rng) for i in xrange(10) for j in xrange(10)]
        assert_vec_approx_equal(y, expected, tester=self)
...
class KTBEvolveCrop(unittest.TestCase):
    ...
    def runTest(self):
        ...
        continuous.simulate_continuous(root, rng, roeotroe=0.01,
