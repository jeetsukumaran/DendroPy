...
class SplitDistribution(object):
    ...
    def calc_freqs(self):
        ...
        for split in self.split_counts:
            self.__split_freqs[split] = float(self.split_counts[split]) / self.total_trees_counted
        for split in self.complemented_split_counts:
            self.__complemented_split_freqs[split] = float(self.complemented_split_counts[split]) / self.total_trees_counted
