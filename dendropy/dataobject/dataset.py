...
from dendropy.dataobject.base import Annotated
...
class DataSet(Annotated, iosys.Readable, iosys.Writeable):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        Annotated.__init__(self, label=kwargs.get('label'), oid=kwargs.get('oid'))
