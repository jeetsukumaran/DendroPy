...
In addition to string representations, DendroPy trees can also be visualised using the `iplotx <https://iplotx.readthedocs.io/>`_ package. This workflow can be used to create static raster (e.g. PNG, JPEG)
