...
5.  ``src/dendropy/dataio/_beast2_v2_7_8_lark_standalone.py`` is generated by
    the third-party `Lark <https://github.com/lark-parser/lark>`_ package's
    "Standalone Mode" code generator. This file is separately licensed under
    the `Mozilla Public License, v. 2.0 <https://mozilla.org/MPL/2.0/>`_.
